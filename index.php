...
s1.async=true;
s1.src='https://embed.tawk.to/5ae69fc45f7cdf4f0533b8b2/default';
s1.charset='UTF-8';
...
<!--End of Tawk.to Script-->
		...
		<title>Daksha Consultency</title>
	...
	<body id="top">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <p><i class="fa fa-phone"></i><span> Phone</span>+91 9010552009</p>
                    </div>
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <p><i class="fa fa-envelope-o"></i><span> Email</span><a href="mailto:aganesh651@gmail.com">aganesh651@gmail.com</a></p>
                    </div>
		...
		<nav class="navbar navbar-default templatemo-nav" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a href="#" class="navbar-brand">Deksha</a>
				</div>
    		...
    		<div class="container">
    			<div class="row">
    				<div class="col-md-offset-2 col-md-8">
    					<h1 class="wow fadeIn" data-wow-offset="50" data-wow-delay="0.9s">Dakshah offers a bundle of services on Business Consulting <span></span></h1>
    					<div class="element">
                            <div class="sub-element">provide me some text </div>
                            <div class="sub-element">here also  </div>
                            <div class="sub-element">please make content that u want</div>
                        </div>
		...
		<section id="about">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
    					<h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s">WE ARE <span>DAKSHA</span></h2>
    				</div>
    	...
    	<section id="team">
    		<div class="container">
    			<div class="row">
    				...
    				<div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="1.3s">
    					<div class="team-wrapper">
    						<img src="images/Q-962.jpg" class="img-responsive" alt="team img 3">
    							<div class="team-des">
    								<h4>Ganesh</h4>
    								<span>Developer</span>
    								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elitquisque tempus ac eget diam et laoreet phasellus ut nisi id leo molest.</p>
    				...
    				<div class="col-md-3 col-sm-6 col-xs-12 wow fadeIn" data-wow-offset="50" data-wow-delay="1.6s">
    					<div class="team-wrapper">
    						<img src="images/ashok.JPG" class="img-responsive" alt="team img 4">
    							<div class="team-des">
    								<h4>Ashok</h4>
    								<span>Manager</span>
    								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elitquisque tempus ac eget diam et laoreet phasellus ut nisi id leo molest.</p>
    		...
    		<div class="container">
    			<div class="row">
    				...
    				<div class="col-md-4 wow fadeIn" data-wow-offset="50" data-wow-delay="0.6s">
    					...
    					<h4>END-TO-END ERP</h4>
    					<p>
The core team has consulted to a variety of industries prior to estabilishing Dakshah. Dakshah leverages this experience in serving cients for ERP, Business consulting and Applications services in these verticals.</p>
    				</div>
    				<div class="col-md-4 active wow fadeIn" data-wow-offset="50" data-wow-delay="0.9s">
    					<i class="fa fa-cloud"></i>
    					<h4>Oracle E-Business</h4>
    					<p>Our consulting team has 10 years each on Oracle E-Business suite covering Financials, Distribution, Manufacturing, CRM and Projects. They were among the first in India to start consulting on Oracle Applications. Backed by our un-paralleled experience, we offer end-to-end services on Oracle E-Business suite..</p>
    				</div>
    				<div class="col-md-4 wow fadeIn" data-wow-offset="50" data-wow-delay="0.6s">
    					<i class="fa fa-cog"></i>
    					<h4>ADD SOME NEW </h4>
    	...
    	<section id="portfolio">
    		<div class="container">
    			<div class="row">
    				<div class="col-md-12">
    					<h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s"><span>OUR </span> TESTIMONIALS</h2>
    				</div>
    	...
    	<section id="contact">
    		<div class="container">
    			<div class="row">
    				<div class="col-md-12">
    					<h2 class="wow bounceIn" data-wow-offset="50" data-wow-delay="0.3s">CONTACT <span></span></h2>
    				</div>
    				<div class="col-md-6 col-sm-6 col-xs-12 wow fadeInLeft" data-wow-offset="50" data-wow-delay="0.9s">
    					<form action="mail.php" method="post">
    						<label>NAME</label>
    						<input name="name" type="text" class="form-control" id="lname">
    				...
    				<div class="col-md-6 col-sm-6 col-xs-12 wow fadeInRight" data-wow-offset="50" data-wow-delay="0.6s">
    					<address>
    						...
    						<p><i class="fa fa-phone"></i> +91 9010552009</p>
    						<p><i class="fa fa-envelope-o"></i> AGANESH651@gmail.com</p>
    						<p><i class="fa fa-map-marker"></i> HYDERBAD, LAKDIKAPOOL 500020.</p>
    					</address>
    					<ul class="social-icon">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        Deksha Consultency; Copyright 2016. Designed By Ganesh Designs</p>
                    </div>
                </div>
            </div>
